...
class OuterParserTest extends FunSuite {
  ...
  test("OuterParser.addTest") {
    ...
    val str = spreadSheetParser.parse("addTest");
  ...
  test("OuterParser.emptyCellTest") {
    ...
    val str = spreadSheetParser.parse("emptyCellTest");
  ...
  test("OuterParser.ifTest") {
    ...
    val str = spreadSheetParser.parse("ifTest");
  ...
  test("OuterParser.simpleArgTest") {
    ...
    val str = spreadSheetParser.parse("simpleArgTest");
  ...
  test("OuterParser.embededArgTest") {
    ...
    val str = spreadSheetParser.parse("embededArgTest");
  ...
  test("OuterParser.nullCellTest") {
    ...
    val str = spreadSheetParser.parse("emptyCellAsArgTest");
