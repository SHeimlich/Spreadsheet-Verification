...
int AK10Num = 1; 
int AK10=__VERIFIER_nondet_int();
int M7Num = 1; 
...
if(9 == 0) 
	 __VERIFIER_error(); 
int W11Num = 1; 
int W11=(W2 + W3 + W4 + W5 + W6 + W7 + W8 + W9 + W10) / 9;
if(M4Num == 0) 
	 __VERIFIER_error(); 
if(L4Num == 0) 
	 __VERIFIER_error(); 
