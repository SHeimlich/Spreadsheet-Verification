...
// on Wednesday, 13 February 2019 at 8:37:13 pm.
...
public final class ExpParser extends ParserBase {
  ...
  public Result pCellRef(final int yyStart) throws IOException {
    ExpParserColumn yyColumn = (ExpParserColumn)column(yyStart);
    if (null == yyColumn.chunk2) yyColumn.chunk2 = new Chunk2();
    if (null == yyColumn.chunk2.fCellRef) 
      yyColumn.chunk2.fCellRef = pCellRef$1(yyStart);
    return yyColumn.chunk2.fCellRef;
  }
  ...
  private Result pNumFormulaLevel2$$Star1(final int yyStart) 
    ...
    if (null == yyColumn.chunk3.fNumFormulaLevel2$$Star1) 
      yyColumn.chunk3.fNumFormulaLevel2$$Star1 = pNumFormulaLevel2$$Star1$1(yyStart);
    return yyColumn.chunk3.fNumFormulaLevel2$$Star1;
  }
