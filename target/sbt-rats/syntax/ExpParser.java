...
// on Tuesday, 7 May 2019 at 6:34:55 pm.
...
public final class ExpParser extends ParserBase {
  ...
  public Result pInteger(final int yyStart) throws IOException {
    ExpParserColumn yyColumn = (ExpParserColumn)column(yyStart);
    if (null == yyColumn.chunk2) yyColumn.chunk2 = new Chunk2();
    if (null == yyColumn.chunk2.fInteger) 
      yyColumn.chunk2.fInteger = pInteger$1(yyStart);
    return yyColumn.chunk2.fInteger;
  }

  /** Actually parse syntax.ExpParser.Integer. */
  private Result pInteger$1(final int yyStart) throws IOException {
    int        yyC;
    int        yyIndex;
    Result     yyResult;
    int        yyBase;
