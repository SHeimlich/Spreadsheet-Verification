...
// on Tuesday, 14 May 2019 at 3:27:58 pm.
...
public final class ExpParser extends ParserBase {
  ...
  static final class Chunk3 {
    Result fFormulaLevel2;
    Result fFormulaLevel2$$Star1;
    Result fFormulaLevel1;
    Result fFormulaLevel1$$Star1;
    Result fFormulaLevel0;
    Result fFormulaLevel0$$Plus1;
    Result fFormulaLevel0$$Plus2;
    Result fFormulaLevel0$$Plus3;
    Result fFormulaLevel0$$Plus4;
    Result fFormulaLevel0$$Plus5;
  }

  /** Chunk 4 of memoized results. */
  static final class Chunk4 {
    Result fFormulaLevel0$$Plus6;
    Result fWord;
  }
  ...
  /**
   * Parse nonterminal syntax.ExpParser.Symbol5.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pSymbol5(final int yyStart) throws IOException {
    Result     yyResult;
    String     yyValue;
  ...
  /**
   * Parse nonterminal syntax.ExpParser.Symbol5Alts.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pSymbol5Alts(final int yyStart) throws IOException {
    int        yyC;
    int        yyIndex;
    String     yyValue;
    ParseError yyError = ParseError.DUMMY;
    ...
    // Done.
    yyError = yyError.select("symbol5 alts expected", yyStart);
    return yyError;
  }
  ...
  /**
   * Parse nonterminal syntax.ExpParser.Symbol12.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
  ...
  /**
   * Parse nonterminal syntax.ExpParser.Symbol12Alts.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
  ...
  public Result pAssign(final int yyStart) throws IOException {
    ...
    yyError  = yyResult.select(yyError);
    if (yyResult.hasValue()) {
      Formula v1 = yyResult.semanticValue();
  ...
  public Result passignIf(final int yyStart) throws IOException {
    ...
    while (true) {
      ...
      if (yyResult.hasValue()) {
        ...
        yyRepeated1   = true;
        yyRepValue1   = new Pair<ifRef>(v$el$1, yyRepValue1);
        continue;
      }
      break;
    }
    ...
    if (yyRepeated1) {
      Pair<ifRef> v1 = yyRepValue1.reverse();
  ...
  public Result pFormula(final int yyStart) throws IOException {
    ExpParserColumn yyColumn = (ExpParserColumn)column(yyStart);
    if (null == yyColumn.chunk1) yyColumn.chunk1 = new Chunk1();
    if (null == yyColumn.chunk1.fFormula) 
      yyColumn.chunk1.fFormula = pFormula$1(yyStart);
    return yyColumn.chunk1.fFormula;
  }

  /** Actually parse syntax.ExpParser.Formula. */
  private Result pFormula$1(final int yyStart) throws IOException {
    Result     yyResult;
    Formula    yyValue;
    ParseError yyError = ParseError.DUMMY;
    ...
    yyResult = pFormulaLevel3(yyStart);
    yyError  = yyResult.select(yyError);
    if (yyResult.hasValue()) {
      Formula v1 = yyResult.semanticValue();
  ...
  private Result pnIf$1(final int yyStart) throws IOException {
    ...
    if (yyResult.hasValue()) {
      ...
      yyError  = yyResult.select(yyError);
      if (yyResult.hasValue()) {
        Pair<Formula> v1 = yyResult.semanticValue();
        ...
        if (yyResult.hasValue()) {
          ...
          yyError  = yyResult.select(yyError);
          if (yyResult.hasValue()) {
            Pair<Formula> v2 = yyResult.semanticValue();
            ...
            if (yyResult.hasValue()) {
              ...
              yyError  = yyResult.select(yyError);
              if (yyResult.hasValue()) {
                Pair<Formula> v3 = yyResult.semanticValue();
  ...
  private Result pnIf$$Plus2$1(final int yyStart) throws IOException {
    Result        yyResult;
    Pair<Formula> yyValue;
    ParseError    yyError = ParseError.DUMMY;

    // Alternative 1.

    yyResult = pFormula(yyStart);
    yyError  = yyResult.select(yyError);
    if (yyResult.hasValue()) {
      Formula v$el$1 = yyResult.semanticValue();
      ...
      yyError  = yyResult.select(yyError);
      if (yyResult.hasValue()) {
        Pair<Formula> v$2 = yyResult.semanticValue();

        yyValue = new Pair<Formula>(v$el$1, v$2);
      ...
      yyValue = new Pair<Formula>(v$el$1);
  ...
  private Result pnIf$$Plus4$1(final int yyStart) throws IOException {
    ...
    yyError  = yyResult.select(yyError);
    if (yyResult.hasValue()) {
      Formula v$el$3 = yyResult.semanticValue();
      ...
      yyError  = yyResult.select(yyError);
      if (yyResult.hasValue()) {
        Pair<Formula> v$4 = yyResult.semanticValue();

        yyValue = new Pair<Formula>(v$el$3, v$4);
      ...
      yyValue = new Pair<Formula>(v$el$3);
  ...
  private Result pnIf$$Plus6$1(final int yyStart) throws IOException {
    ...
    yyError  = yyResult.select(yyError);
    if (yyResult.hasValue()) {
      Formula v$el$5 = yyResult.semanticValue();
      ...
      yyError  = yyResult.select(yyError);
      if (yyResult.hasValue()) {
        Pair<Formula> v$6 = yyResult.semanticValue();

        yyValue = new Pair<Formula>(v$el$5, v$6);
      ...
      yyValue = new Pair<Formula>(v$el$5);
  ...
  public Result pNumConstant(final int yyStart) throws IOException {
    ExpParserColumn yyColumn = (ExpParserColumn)column(yyStart);
    if (null == yyColumn.chunk2) yyColumn.chunk2 = new Chunk2();
    if (null == yyColumn.chunk2.fNumConstant) 
      yyColumn.chunk2.fNumConstant = pNumConstant$1(yyStart);
    return yyColumn.chunk2.fNumConstant;
  }

  /** Actually parse syntax.ExpParser.NumConstant. */
  private Result pNumConstant$1(final int yyStart) throws IOException {
    Result     yyResult;
    Formula    yyValue;
    ParseError yyError = ParseError.DUMMY;
  ...
  private Result pifRef$1(final int yyStart) throws IOException {
    ...
    yyError  = yyResult.select(yyError);
    if (yyResult.hasValue()) {
      Pair<String> v1 = yyResult.semanticValue();
  ...
  /**
   * Parse nonterminal syntax.ExpParser.Number.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  public Result pNumber(final int yyStart) throws IOException {
    Result     yyResult;
    String     yyValue;
    ParseError yyError = ParseError.DUMMY;
  ...
  /**
   * Parse nonterminal syntax.ExpParser.Decimal.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
  ...
  public Result pDecimal(final int yyStart) throws IOException {
    ...
    if (yyResult.hasValue()) {
      ...
      if (yyResult.hasValue(".")) {
        ...
        yyResult = pDigits(yyResult.index);
        yyError  = yyResult.select(yyError);
        if (yyResult.hasValue()) {
          String v2 = yyResult.semanticValue();
  ...
  public Result pDigits(final int yyStart) throws IOException {
    ExpParserColumn yyColumn = (ExpParserColumn)column(yyStart);
    if (null == yyColumn.chunk2) yyColumn.chunk2 = new Chunk2();
    if (null == yyColumn.chunk2.fDigits) 
      yyColumn.chunk2.fDigits = pDigits$1(yyStart);
    return yyColumn.chunk2.fDigits;
  }

  /** Actually parse syntax.ExpParser.Digits. */
  private Result pDigits$1(final int yyStart) throws IOException {
    int        yyC;
    int        yyIndex;
    Result     yyResult;
    String     yyValue;
  ...
  /**
   * Parse nonterminal syntax.ExpParser.FormulaLevel2.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  public Result pFormulaLevel2(final int yyStart) throws IOException {
    ExpParserColumn yyColumn = (ExpParserColumn)column(yyStart);
    if (null == yyColumn.chunk3) yyColumn.chunk3 = new Chunk3();
    if (null == yyColumn.chunk3.fFormulaLevel2) 
      yyColumn.chunk3.fFormulaLevel2 = pFormulaLevel2$1(yyStart);
    return yyColumn.chunk3.fFormulaLevel2;
  }

  /** Actually parse syntax.ExpParser.FormulaLevel2. */
  private Result pFormulaLevel2$1(final int yyStart) throws IOException {
    Result     yyResult;
    Formula    yyValue;
    ParseError yyError = ParseError.DUMMY;
    ...
    yyResult = pFormulaLevel1(yyStart);
    yyError  = yyResult.select(yyError);
    if (yyResult.hasValue()) {
      Formula v1 = yyResult.semanticValue();

      yyResult = pFormulaLevel2$$Star1(yyResult.index);
      yyError  = yyResult.select(yyError);
      if (yyResult.hasValue()) {
        Pair<Action<Formula>> v2 = yyResult.semanticValue();
  ...
  /**
   * Parse synthetic nonterminal syntax.ExpParser.FormulaLevel2$$Star1.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pFormulaLevel2$$Star1(final int yyStart) throws IOException {
    ExpParserColumn yyColumn = (ExpParserColumn)column(yyStart);
    if (null == yyColumn.chunk3) yyColumn.chunk3 = new Chunk3();
    if (null == yyColumn.chunk3.fFormulaLevel2$$Star1) 
      yyColumn.chunk3.fFormulaLevel2$$Star1 = pFormulaLevel2$$Star1$1(yyStart);
    return yyColumn.chunk3.fFormulaLevel2$$Star1;
  }

  /** Actually parse syntax.ExpParser.FormulaLevel2$$Star1. */
  private Result pFormulaLevel2$$Star1$1(final int yyStart) 
    throws IOException {

    Result                yyResult;
    Pair<Action<Formula>> yyValue;
    ParseError            yyError = ParseError.DUMMY;

    // Alternative 1.

    yyResult = pFormulaLevel2Tail(yyStart);
    yyError  = yyResult.select(yyError);
    if (yyResult.hasValue()) {
      Action<Formula> v$el$1 = yyResult.semanticValue();

      yyResult = pFormulaLevel2$$Star1(yyResult.index);
      yyError  = yyResult.select(yyError);
      if (yyResult.hasValue()) {
        Pair<Action<Formula>> v$2 = yyResult.semanticValue();

        yyValue = new Pair<Action<Formula>>(v$el$1, v$2);
  ...
  /**
   * Parse nonterminal syntax.ExpParser.FormulaLevel2Tail.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pFormulaLevel2Tail(final int yyStart) throws IOException {
    Result          yyResult;
    Action<Formula> yyValue;
    ParseError      yyError = ParseError.DUMMY;
    ...
    if (yyResult.hasValue("+")) {
      ...
      yyResult = pFormulaLevel1(yyResult.index);
      yyError  = yyResult.select(yyError);
      if (yyResult.hasValue()) {
        final Formula v1 = yyResult.semanticValue();
    ...
    // Done.
    yyError = yyError.select("formula level2 tail expected", yyStart);
    return yyError;
  }
  ...
  /**
   * Parse nonterminal syntax.ExpParser.FormulaLevel1.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  public Result pFormulaLevel1(final int yyStart) throws IOException {
    ExpParserColumn yyColumn = (ExpParserColumn)column(yyStart);
    if (null == yyColumn.chunk3) yyColumn.chunk3 = new Chunk3();
    if (null == yyColumn.chunk3.fFormulaLevel1) 
      yyColumn.chunk3.fFormulaLevel1 = pFormulaLevel1$1(yyStart);
    return yyColumn.chunk3.fFormulaLevel1;
  }

  /** Actually parse syntax.ExpParser.FormulaLevel1. */
  private Result pFormulaLevel1$1(final int yyStart) throws IOException {
    Result     yyResult;
    Formula    yyValue;
    ParseError yyError = ParseError.DUMMY;
    ...
    yyResult = pFormulaLevel0(yyStart);
    yyError  = yyResult.select(yyError);
    if (yyResult.hasValue()) {
      Formula v1 = yyResult.semanticValue();

      yyResult = pFormulaLevel1$$Star1(yyResult.index);
      yyError  = yyResult.select(yyError);
      if (yyResult.hasValue()) {
        Pair<Action<Formula>> v2 = yyResult.semanticValue();
  ...
  /**
   * Parse synthetic nonterminal syntax.ExpParser.FormulaLevel1$$Star1.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pFormulaLevel1$$Star1(final int yyStart) throws IOException {
    ExpParserColumn yyColumn = (ExpParserColumn)column(yyStart);
    if (null == yyColumn.chunk3) yyColumn.chunk3 = new Chunk3();
    if (null == yyColumn.chunk3.fFormulaLevel1$$Star1) 
      yyColumn.chunk3.fFormulaLevel1$$Star1 = pFormulaLevel1$$Star1$1(yyStart);
    return yyColumn.chunk3.fFormulaLevel1$$Star1;
  }

  /** Actually parse syntax.ExpParser.FormulaLevel1$$Star1. */
  private Result pFormulaLevel1$$Star1$1(final int yyStart) 
    throws IOException {
    ...
    yyResult = pFormulaLevel1Tail(yyStart);
    yyError  = yyResult.select(yyError);
    if (yyResult.hasValue()) {
      Action<Formula> v$el$1 = yyResult.semanticValue();
  ...
  /**
   * Parse nonterminal syntax.ExpParser.FormulaLevel1Tail.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pFormulaLevel1Tail(final int yyStart) throws IOException {
    Result          yyResult;
    Action<Formula> yyValue;
    ParseError      yyError = ParseError.DUMMY;
    ...
    if (yyResult.hasValue("*")) {
      ...
      yyResult = pFormulaLevel0(yyResult.index);
      yyError  = yyResult.select(yyError);
      if (yyResult.hasValue()) {
        final Formula v1 = yyResult.semanticValue();
    ...
    // Done.
    yyError = yyError.select("formula level1 tail expected", yyStart);
    return yyError;
  }
  ...
  /**
   * Parse nonterminal syntax.ExpParser.FormulaLevel3.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  public Result pFormulaLevel3(final int yyStart) throws IOException {
    Result                yyResult;
    int                   yyRepetition1;
    Pair<Action<Formula>> yyRepValue1;
    Formula               yyValue;
    ParseError            yyError = ParseError.DUMMY;

    // Alternative 1.

    yyResult = pFormulaLevel2(yyStart);
    yyError  = yyResult.select(yyError);
    if (yyResult.hasValue()) {
      Formula v1 = yyResult.semanticValue();
      ...
      while (true) {
        ...
        yyResult = pFormulaLevel3Tail(yyRepetition1);
        yyError  = yyResult.select(yyError, yyRepetition1);
        if (yyResult.hasValue()) {
          Action<Formula> v$el$1 = yyResult.semanticValue();

          yyRepetition1 = yyResult.index;
          yyRepValue1   = new Pair<Action<Formula>>(v$el$1, yyRepValue1);
          continue;
        }
        break;
      }
      { // Start scope for v2.
        Pair<Action<Formula>> v2 = yyRepValue1.reverse();
  ...
  /**
   * Parse nonterminal syntax.ExpParser.FormulaLevel3Tail.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pFormulaLevel3Tail(final int yyStart) throws IOException {
    Result          yyResult;
    Action<Formula> yyValue;
    ParseError      yyError = ParseError.DUMMY;
    ...
    if (yyResult.hasValue("^")) {
      ...
      yyResult = pFormulaLevel2(yyResult.index);
      yyError  = yyResult.select(yyError);
      if (yyResult.hasValue()) {
        final Formula v1 = yyResult.semanticValue();
    ...
    // Done.
    yyError = yyError.select("formula level3 tail expected", yyStart);
    return yyError;
  }
  ...
  /**
   * Parse nonterminal syntax.ExpParser.FormulaLevel0.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  public Result pFormulaLevel0(final int yyStart) throws IOException {
    ExpParserColumn yyColumn = (ExpParserColumn)column(yyStart);
    if (null == yyColumn.chunk3) yyColumn.chunk3 = new Chunk3();
    if (null == yyColumn.chunk3.fFormulaLevel0) 
      yyColumn.chunk3.fFormulaLevel0 = pFormulaLevel0$1(yyStart);
    return yyColumn.chunk3.fFormulaLevel0;
  }

  /** Actually parse syntax.ExpParser.FormulaLevel0. */
  private Result pFormulaLevel0$1(final int yyStart) throws IOException {
    Result     yyResult;
    int        yyBase;
    Formula    yyValue;
    ParseError yyError = ParseError.DUMMY;
    ...
    yyResult = pFormulaLevel0$$Plus1(yyStart);
    yyError  = yyResult.select(yyError);
    if (yyResult.hasValue()) {

      yyResult = pFormulaLevel0$$Plus2(yyResult.index);
      yyError  = yyResult.select(yyError);
      if (yyResult.hasValue()) {
    ...
    yyResult = pFormulaLevel0$$Plus3(yyStart);
    yyError  = yyResult.select(yyError);
    if (yyResult.hasValue()) {

      yyResult = pFormulaLevel0$$Plus4(yyResult.index);
      yyError  = yyResult.select(yyError);
      if (yyResult.hasValue()) {
        Pair<NumArguments> v1 = yyResult.semanticValue();
    ...
    yyResult = pFormulaLevel0$$Plus5(yyStart);
    yyError  = yyResult.select(yyError);
    if (yyResult.hasValue()) {

      yyResult = pFormulaLevel0$$Plus6(yyResult.index);
      yyError  = yyResult.select(yyError);
      if (yyResult.hasValue()) {
        Pair<NumArguments> v1 = yyResult.semanticValue();
    ...
    yyResult = pSymbol5(yyStart);
    if (yyResult.hasValue("NOW()")) {
    ...
    // Done.
    yyError = yyError.select("formula level0 expected", yyStart);
    return yyError;
  }
  ...
  /**
   * Parse synthetic nonterminal syntax.ExpParser.FormulaLevel0$$Plus1.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pFormulaLevel0$$Plus1(final int yyStart) throws IOException {
    ExpParserColumn yyColumn = (ExpParserColumn)column(yyStart);
    if (null == yyColumn.chunk3) yyColumn.chunk3 = new Chunk3();
    if (null == yyColumn.chunk3.fFormulaLevel0$$Plus1) 
      yyColumn.chunk3.fFormulaLevel0$$Plus1 = pFormulaLevel0$$Plus1$1(yyStart);
    return yyColumn.chunk3.fFormulaLevel0$$Plus1;
  }

  /** Actually parse syntax.ExpParser.FormulaLevel0$$Plus1. */
  private Result pFormulaLevel0$$Plus1$1(final int yyStart) 
    throws IOException {
    ...
    if (yyResult.hasValue("SUM(")) {
      ...
      yyResult = pFormulaLevel0$$Plus1(yyChoice1);
      yyError  = yyResult.select(yyError);
      if (yyResult.hasValue()) {
  ...
  /**
   * Parse synthetic nonterminal syntax.ExpParser.FormulaLevel0$$Plus2.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pFormulaLevel0$$Plus2(final int yyStart) throws IOException {
    ExpParserColumn yyColumn = (ExpParserColumn)column(yyStart);
    if (null == yyColumn.chunk3) yyColumn.chunk3 = new Chunk3();
    if (null == yyColumn.chunk3.fFormulaLevel0$$Plus2) 
      yyColumn.chunk3.fFormulaLevel0$$Plus2 = pFormulaLevel0$$Plus2$1(yyStart);
    return yyColumn.chunk3.fFormulaLevel0$$Plus2;
  }

  /** Actually parse syntax.ExpParser.FormulaLevel0$$Plus2. */
  private Result pFormulaLevel0$$Plus2$1(final int yyStart) 
    throws IOException {
    ...
    if (yyResult.hasValue()) {
      ...
      yyResult = pFormulaLevel0$$Plus2(yyChoice1);
      yyError  = yyResult.select(yyError);
      if (yyResult.hasValue()) {
        Pair<NumArguments> v$2 = yyResult.semanticValue();

        yyValue = new Pair<NumArguments>(v$el$1, v$2);
      ...
      yyValue = new Pair<NumArguments>(v$el$1);
  ...
  /**
   * Parse synthetic nonterminal syntax.ExpParser.FormulaLevel0$$Plus3.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pFormulaLevel0$$Plus3(final int yyStart) throws IOException {
    ExpParserColumn yyColumn = (ExpParserColumn)column(yyStart);
    if (null == yyColumn.chunk3) yyColumn.chunk3 = new Chunk3();
    if (null == yyColumn.chunk3.fFormulaLevel0$$Plus3) 
      yyColumn.chunk3.fFormulaLevel0$$Plus3 = pFormulaLevel0$$Plus3$1(yyStart);
    return yyColumn.chunk3.fFormulaLevel0$$Plus3;
  }

  /** Actually parse syntax.ExpParser.FormulaLevel0$$Plus3. */
  private Result pFormulaLevel0$$Plus3$1(final int yyStart) 
    throws IOException {
    ...
    if (yyResult.hasValue("AVERAGE(")) {
      ...
      yyResult = pFormulaLevel0$$Plus3(yyChoice1);
      yyError  = yyResult.select(yyError);
      if (yyResult.hasValue()) {
  ...
  /**
   * Parse synthetic nonterminal syntax.ExpParser.FormulaLevel0$$Plus4.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pFormulaLevel0$$Plus4(final int yyStart) throws IOException {
    ExpParserColumn yyColumn = (ExpParserColumn)column(yyStart);
    if (null == yyColumn.chunk3) yyColumn.chunk3 = new Chunk3();
    if (null == yyColumn.chunk3.fFormulaLevel0$$Plus4) 
      yyColumn.chunk3.fFormulaLevel0$$Plus4 = pFormulaLevel0$$Plus4$1(yyStart);
    return yyColumn.chunk3.fFormulaLevel0$$Plus4;
  }

  /** Actually parse syntax.ExpParser.FormulaLevel0$$Plus4. */
  private Result pFormulaLevel0$$Plus4$1(final int yyStart) 
    throws IOException {
    ...
    if (yyResult.hasValue()) {
      ...
      yyResult = pFormulaLevel0$$Plus4(yyChoice1);
      yyError  = yyResult.select(yyError);
      if (yyResult.hasValue()) {
        Pair<NumArguments> v$4 = yyResult.semanticValue();

        yyValue = new Pair<NumArguments>(v$el$3, v$4);
      ...
      yyValue = new Pair<NumArguments>(v$el$3);
  ...
  /**
   * Parse synthetic nonterminal syntax.ExpParser.FormulaLevel0$$Plus5.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pFormulaLevel0$$Plus5(final int yyStart) throws IOException {
    ExpParserColumn yyColumn = (ExpParserColumn)column(yyStart);
    if (null == yyColumn.chunk3) yyColumn.chunk3 = new Chunk3();
    if (null == yyColumn.chunk3.fFormulaLevel0$$Plus5) 
      yyColumn.chunk3.fFormulaLevel0$$Plus5 = pFormulaLevel0$$Plus5$1(yyStart);
    return yyColumn.chunk3.fFormulaLevel0$$Plus5;
  }

  /** Actually parse syntax.ExpParser.FormulaLevel0$$Plus5. */
  private Result pFormulaLevel0$$Plus5$1(final int yyStart) 
    throws IOException {
    ...
    if (yyResult.hasValue("CONCATENATE(")) {

      final int yyChoice1 = yyResult.index;

      // Nested alternative 1.

      yyResult = pFormulaLevel0$$Plus5(yyChoice1);
      yyError  = yyResult.select(yyError);
      if (yyResult.hasValue()) {
  ...
  /**
   * Parse synthetic nonterminal syntax.ExpParser.FormulaLevel0$$Plus6.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pFormulaLevel0$$Plus6(final int yyStart) throws IOException {
    ExpParserColumn yyColumn = (ExpParserColumn)column(yyStart);
    if (null == yyColumn.chunk4) yyColumn.chunk4 = new Chunk4();
    if (null == yyColumn.chunk4.fFormulaLevel0$$Plus6) 
      yyColumn.chunk4.fFormulaLevel0$$Plus6 = pFormulaLevel0$$Plus6$1(yyStart);
    return yyColumn.chunk4.fFormulaLevel0$$Plus6;
  }

  /** Actually parse syntax.ExpParser.FormulaLevel0$$Plus6. */
  private Result pFormulaLevel0$$Plus6$1(final int yyStart) 
    throws IOException {
    ...
    yyError  = yyResult.select(yyError);
    if (yyResult.hasValue()) {
      NumArguments v$el$5 = yyResult.semanticValue();

      final int yyChoice1 = yyResult.index;

      // Nested alternative 1.

      yyResult = pFormulaLevel0$$Plus6(yyChoice1);
      yyError  = yyResult.select(yyError);
      if (yyResult.hasValue()) {
        Pair<NumArguments> v$6 = yyResult.semanticValue();

        yyValue = new Pair<NumArguments>(v$el$5, v$6);
      ...
      yyValue = new Pair<NumArguments>(v$el$5);
