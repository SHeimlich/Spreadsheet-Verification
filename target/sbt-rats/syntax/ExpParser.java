...
// on Thursday, 4 April 2019 at 12:56:36 pm.
  ...
  public Result pStringFormula(final int yyStart) throws IOException {
    ...
    while (true) {
      ...
      if (yyResult.hasValue("CONCATENATE(")) {
        ...
        yyError = yyError.select("'CONCATENATE(' expected", yyBase);
      }
      break;
    }
    ...
    if (yyRepeated1) {
      ...
      while (true) {
        ...
        yyResult = pNumArguments(yyRepetition1);
        yyError  = yyResult.select(yyError);
        if (yyResult.hasValue()) {
          ...
          yyRepetition1 = yyResult.index;
          yyRepeated1   = true;
          yyRepValue1   = new Pair<NumArguments>(v$el$1, yyRepValue1);
          continue;
        }
        break;
      }
      ...
      if (yyRepeated1) {
        Pair<NumArguments> v1 = yyRepValue1.reverse();
