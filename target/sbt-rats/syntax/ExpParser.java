...
public final class ExpParser extends ParserBase {
  ...
  public Result passignIf(final int yyStart) throws IOException {
    ...
    if (yyRepeated1) {
      Pair<ifRef> v1 = cast(yyRepValue1.reverse());
      ...
      if (yyRepeated1) {
        ...
        if (yyRepeated1) {
          Pair<NumFormula> v2 = cast(yyRepValue1.reverse());
          ...
          if (yyRepeated1) {
            ...
            if (yyRepeated1) {
              Pair<NumFormula> v3 = cast(yyRepValue1.reverse());
              ...
              if (yyRepeated1) {
                ...
                if (yyRepeated1) {
                  Pair<NumFormula> v4 = cast(yyRepValue1.reverse());
